...
export async function GET(): Promise<NextResponse> {
    ...
    if (daysBetween < 1) {
        return NextResponse.json({message: "Plan already marked as complete today"}, {status: 420});
    }
    ...
    return NextResponse.json({message: "Marked daily plan as complete"}, {status: 200});
}
